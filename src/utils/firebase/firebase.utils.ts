...
/**
 * get the categories data from firebase storage
 * 
 * @returns a Category array containing the document snapshot
 */
export const getCategoriesAndDocuments = async (): Promise<Category[]> => {
  ...
  //cast as category because we know what firebase will give us but typescript doesn't 
